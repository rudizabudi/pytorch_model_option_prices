...
class DataCreationConfig:
    ...
    OUTPUT_TYPE: OutputType = OutputType.BACKUP  # BACKUP | TRAINING
    ...
    END_DATE_WEEKDAYS: int = 3  # Weekdays before today to cut-off data
    ...
    FMP_API_KEY: str = 'rbfZHTUCSk52aCXELDmES40UraSXKgJL,eQeWi3SJy3cfiJxBRN1nuYva71lW2EFU,yauaLdTo5qtEQ2MF9i2jKHFQ9i2gdwG7'  # financialmodelingprep API Key
    FMP_CHANGE_KEY: int = 240  # change api key after X requests

    # DO NOT CHANGE
    FMP_API_KEY = tuple(FMP_API_KEY.split(','))
